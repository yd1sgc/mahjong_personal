...
HOUSE_RULES = {
    "精算": [
        "25,000点持ち / 30,000点返し / 持ち点ゼロでも続行",
        "10-30：1位+50 / 2位+10 / 3位-10 / 4位-30",
        "ノーテン罰符：3,000点均等分配",
    ],
    "試合の流れ": [
        "半荘戦 / 西入り：トップ30,000点未満で継続 / 北入りなし",
        "座席：つかみ取り / 起家：サイコロ2振り / 開門：1振り",
    ...
    "特殊ルール": [
        ...
        "喰い変えなし / ツモ番なしリーチ不可",
        "フリテンリーチ・見逃しあり（和了はツモのみ）",
        "カン4回まで（同一人物4回は継続、それ以外流局）",
